...
gulp.task('packing', ['html-minify', 'css-minify', 'css-copy', 'js-minify', 'js-copy', 'fonts-copy', 'images-copy', 'sounds-copy','xml-copy', 'manifest-generate', 'other-files'], function(cb){
    ...
    return fs.writeFile(buildFile, buffer, cb);
});
